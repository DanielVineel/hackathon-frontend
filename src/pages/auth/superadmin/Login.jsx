  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (user.role !== USER_TYPES.SUPERADMIN) {
        setError("Unauthorized: Only SuperAdmin accounts can login here");
        return;
      }
    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="auth-header">
          ...
          <p className="subtitle">Platform administration and system management</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="auth-form">
          ...
          <div className="form-options">
            ...
            <Link to="/auth/superadmin/forgot-password" className="forgot-password-link">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="auth-footer">
          <p className="warning-text">
            ⚠️ Unauthorized access attempts will be logged and monitored
          </p>
